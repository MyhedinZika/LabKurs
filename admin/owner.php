...
<div class="page-body">
  ...
  <?php
  $conn = mysqli_connect("mysql.grandmaspizza.online-presence.com", "gr4ndm45", "P!z2z2a00", "grandmaspizza");
  ...
  if (!empty($_POST["search"]["post_at"])) {
    ...
    $queryCondition .= " AND orderDate BETWEEN '$fiy-$fim-$fid' AND '" . $post_at_todate . "'";
  }
